...
%%----------------------------------------
\title{Enhancing ML Models for Solar Weather Forecasting using Clustering and Adversarial Anomaly Detection}
\author{Ivo Saavedra}
...
\committeemember{President}{Carlos Soares}
\committeemember{Referee}{André Restivo}
\committeemember{Referee}{Filipa Barros}
\committeemember{Referee}{Jarle Brinchmann}
