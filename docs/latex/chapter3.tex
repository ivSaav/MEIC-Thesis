...
\begin{table}[ht]
    ...
    \multirow{4}{*}{Inclusion}                     & I1          & The document focuses on clustering algorithms, evaluation metrics or methods.                                                                                                                                                       \\
                                                   ...
                                                   & I4          & \begin{tabular}[c]{@{}l@{}}Provides a comparison between the method and other clustering approaches\\  or analyses multiple clustering approaches for a given application.\end{tabular}                                             \\ \midrule
    \multicolumn{1}{c}{\multirow{4}{*}{Exclusion}} & E1          & \begin{tabular}[c]{@{}l@{}}The article doesn't cover clustering. This can occur due to the ambiguity of the term "cluster", \\ as it can also be used in biology to talk about gene clusters.\end{tabular}                          \\
    \multicolumn{1}{c}{}                           & E2          & The paper does not clearly evaluate the results of the approach.                                                                                                                                                                    \\
    \multicolumn{1}{c}{}                           & E3          & \begin{tabular}[c]{@{}l@{}}The number of recorded citations is less than 50. As clustering is a well-developed study, \\ the criteria for the relevancy of the paper can be more restrictive than on other approaches.\end{tabular} \\
    \multicolumn{1}{c}{}                           & E4          & Was published before 2014.                                                                                                                                                                                                          \\ \bottomrule
    \end{tabular}
\end{table}

The result processing pipeline can be seen in fig. \ref{}
